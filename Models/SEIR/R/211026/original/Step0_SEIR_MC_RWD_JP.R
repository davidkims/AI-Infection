...
df_jp<-df1%>% filter(state=="Japan")
df_jp1<-df_jp[df_jp$date>="2021-06-01" & df_jp$date <"2021-10-04",]
df_jp1$people_vaccinated[is.na(df_jp1$people_vaccinated)]<-mean(df_jp1$people_vaccinated, na.rm = TRUE)
df_jp1$people_fully_vaccinated[is.na(df_jp1$people_fully_vaccinated)]<-mean(df_jp1$people_fully_vaccinated, na.rm = TRUE)
#df_jp1[is.na(df_jp1)] <- 0

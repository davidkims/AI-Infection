...
plot1<-ggplot(q1_lhs) + 
  ...
  geom_line(aes(x = dates, y = D_cum), size = 2, color="red", group = 1) + 
#  geom_ribbon(data = q1_lhs, aes(x = dates, ymin = low, ymax = high), fill="red", alpha = .1) +
  geom_line(data=q2_lhs, aes(x = dates, y = D_cum), size = 2, color = "#FF9999") +
#  geom_ribbon(data = q2_lhs, aes(x = dates, ymin = low, ymax = high), fill="red", alpha = .05) +

  geom_line(data=q3_lhs, aes(x = dates, y = D_cum), size = 2, color = "#CC0033") +
#  geom_ribbon(data = q3_lhs, aes(x = dates, ymin = low, ymax = high), fill="red", alpha = .15) +
  ...
  scale_y_continuous(breaks = seq(2000,3000,200), minor_breaks = seq(2000,3000,200), limits = c(2000, 3000), expand = c(0, 0)) + ## scale_y_continuous(label=comma)
...
#  geom_ribbon(data = q1_lhs, aes(x = dates, ymin = low, ymax = high), fill="red", alpha = .1) +
  ...
  geom_line(data=q2_lhs, aes(x = dates, y = D_cum), size = 2, color = "#FF9999", fill = "white") +
#  geom_ribbon(data = q2_lhs, aes(x = dates, ymin = low, ymax = high), fill="red", alpha = .05) +
  
  geom_line(data=q3_lhs, aes(x = dates, y = D_cum), size = 2, color = "#CC0033", fill = "white") +
#  geom_ribbon(data = q3_lhs, aes(x = dates, ymin = low, ymax = high),fill="red", alpha = .15) +

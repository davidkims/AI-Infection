...
setwd("/Users/hong-eun-yeong/Documents/git_re/03_code/SEIR/version9/hey")
...
df_kr1<-df_kr[df_kr$date>="2021-06-01" & df_kr$date <"2021-10-04",]
...
######################################vaccination data#################################################################
read_csv("vaxx_0926_child_70.csv")->vac_prop
...
read_excel("variants_1005_1.xlsx") -> variants

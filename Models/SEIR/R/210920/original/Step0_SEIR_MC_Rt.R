...
df<-read.csv("/Users/hong-eun-yeong/Documents/GitHub/gil-arim-and-eunyeong/03_code/SEIR/version5/owid-covid-data_0819.csv")
...
# 
 ...
 incidence1<-subset(incidence, dates >= "2021-07-01" & dates < "2021-08-20")

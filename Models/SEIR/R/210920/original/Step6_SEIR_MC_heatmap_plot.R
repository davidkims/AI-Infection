...
vac.test.base1 <-mapply(ts.sir.calc1, Rt=1, npi1=49, npi2 =1, vaccinating=rep(c(0.8, 0.9,1, 1.1,1.2), each=5), testing=rep(c(0.8,0.9, 1, 1.1, 1.2), times=5), SIMPLIFY=FALSE)
vac.test.base2 <-mapply(ts.sir.calc1, Rt=1, npi1=78, npi2 =0.9, vaccinating=rep(c(0.8, 0.9,1, 1.1,1.2), each=5), testing=rep(c(0.8,0.9, 1, 1.1, 1.2), times=5), SIMPLIFY=FALSE)
vac.test.base3 <-mapply(ts.sir.calc1, Rt=1, npi1=103, npi2 =0.9, vaccinating=rep(c(0.8, 0.9,1, 1.1,1.2), each=5), testing=rep(c(0.8,0.9, 1, 1.1, 1.2), times=5), SIMPLIFY=FALSE)
vac.test.base4 <-mapply(ts.sir.calc1, Rt=1.05, npi1=49, npi2 =1, vaccinating=rep(c(0.8, 0.9,1, 1.1,1.2), each=5), testing=rep(c(0.8,0.9, 1, 1.1, 1.2), times=5), SIMPLIFY=FALSE)
vac.test.base5 <-mapply(ts.sir.calc1, Rt=1.05, npi1=78, npi2 =0.9, vaccinating=rep(c(0.8, 0.9,1, 1.1,1.2), each=5), testing=rep(c(0.8,0.9, 1, 1.1, 1.2), times=5), SIMPLIFY=FALSE)
vac.test.base6 <-mapply(ts.sir.calc1, Rt=1.05, npi1=103, npi2 =0.9, vaccinating=rep(c(0.8, 0.9,1, 1.1,1.2), each=5), testing=rep(c(0.8,0.9, 1, 1.1, 1.2), times=5), SIMPLIFY=FALSE)
vac.test.base7 <-mapply(ts.sir.calc1, Rt=1.1, npi1=49, npi2 =1, vaccinating=rep(c(0.8, 0.9,1, 1.1,1.2), each=5), testing=rep(c(0.8,0.9, 1, 1.1, 1.2), times=5), SIMPLIFY=FALSE)
vac.test.base8 <-mapply(ts.sir.calc1, Rt=1.1, npi1=78, npi2 =0.9, vaccinating=rep(c(0.8, 0.9,1, 1.1,1.2), each=5), testing=rep(c(0.8,0.9, 1, 1.1, 1.2), times=5), SIMPLIFY=FALSE)
vac.test.base9 <-mapply(ts.sir.calc1, Rt=1.1, npi1=103, npi2 =0.9, vaccinating=rep(c(0.8, 0.9,1, 1.1,1.2), each=5), testing=rep(c(0.8,0.9, 1, 1.1, 1.2), times=5), SIMPLIFY=FALSE)
...
heatmap1 <- ggplot(data = df_hm_Rt1, 
  ...
  scale_fill_distiller(palette=1, trans="reverse", name = "cum_inc (in thousand)") +
  theme(strip.placement = "outside") +
  theme_classic() +
  geom_text(aes(label = paste0(round(cum_inc), "")), size=2.5) +
  theme(strip.text.y = element_text(size = 6, colour = "black", angle = 270))
...
heatmap2 <- ggplot(data = df_hm_Rt2, 
  ...
  ylab(label = "testing") +
  facet_grid(age ~  npi, scales = "free_y", labeller = label_both) +
  scale_fill_distiller(palette=1, trans="reverse", name = "cum_inc") +
  theme(strip.placement = "outside") +
  theme_classic() +
  geom_text(aes(label = paste0(round(cum_inc), "")), size=2.5) +
  theme(strip.text.y = element_text(size = 6, colour = "black", angle = 270))
...
vac.test.base1 <-mapply(ts.sir.calc2, Rt=1, npi1=49, npi2 =1, vaccinating=rep(c(0.8, 1, 1.2), each=3), testing=rep(c(0.8, 1, 1.2), times=3), SIMPLIFY=FALSE)
vac.test.base2 <-mapply(ts.sir.calc2, Rt=1, npi1=78, npi2 =0.9, vaccinating=rep(c(0.8, 1, 1.2), each=3), testing=rep(c(0.8, 1, 1.2), times=3), SIMPLIFY=FALSE)
vac.test.base3 <-mapply(ts.sir.calc2, Rt=1, npi1=103, npi2 =0.9, vaccinating=rep(c(0.8, 1, 1.2), each=3), testing=rep(c(0.8, 1, 1.2), times=3), SIMPLIFY=FALSE)
vac.test.base4 <-mapply(ts.sir.calc2, Rt=1.05, npi1=49, npi2 =1, vaccinating=rep(c(0.8, 1, 1.2), each=3), testing=rep(c(0.8, 1, 1.2), times=3), SIMPLIFY=FALSE)
vac.test.base5 <-mapply(ts.sir.calc2, Rt=1.05, npi1=78, npi2 =0.9, vaccinating=rep(c(0.8, 1, 1.2), each=3), testing=rep(c(0.8, 1, 1.2), times=3), SIMPLIFY=FALSE)
vac.test.base6 <-mapply(ts.sir.calc2, Rt=1.05, npi1=103, npi2 =0.9, vaccinating=rep(c(0.8, 1, 1.2), each=3), testing=rep(c(0.8, 1, 1.2), times=3), SIMPLIFY=FALSE)
vac.test.base7 <-mapply(ts.sir.calc2, Rt=1.1, npi1=49, npi2 =1, vaccinating=rep(c(0.8, 1, 1.2), each=3), testing=rep(c(0.8, 1, 1.2), times=3), SIMPLIFY=FALSE)
vac.test.base8 <-mapply(ts.sir.calc2, Rt=1.1, npi1=78, npi2 =0.9, vaccinating=rep(c(0.8, 1, 1.2), each=3), testing=rep(c(0.8, 1, 1.2), times=3), SIMPLIFY=FALSE)
vac.test.base9 <-mapply(ts.sir.calc2, Rt=1.1, npi1=103, npi2 =0.9, vaccinating=rep(c(0.8, 1, 1.2), each=3), testing=rep(c(0.8, 1, 1.2), times=3), SIMPLIFY=FALSE)
#  
...
ggsave(out_plot1, filename = "plot1_Rt1_npi1_49_npi2_1_test_vac.png", width = 7, height = 5)
graphics.off()
...
ggsave(out_plot2, filename = "plot2_Rt1_npi1_64_npi2_0.9_test_vac.png", width = 7, height = 5)
graphics.off()
...
ggsave(out_plot3, filename = "plot3_Rt1_npi1_78_npi2_0.9_test_vac.png", width = 7, height = 5)
graphics.off()
...
ggsave(out_plot4, filename = "plot4_Rt1.05_npi1_49_npi2_1_test_vac.png", width = 7, height = 5)
graphics.off()
...
ggsave(out_plot5, filename = "plot5_Rt1.05_npi1_64_npi2_0.9_test_vac.png", width = 7, height = 5)
graphics.off()
...
ggsave(out_plot6, filename = "plot6_Rt1.05_npi1_78_npi2_0.9_test_vac.png", width = 7, height = 5)
graphics.off()
...
ggsave(out_plot7, filename = "plot7_Rt1.1_npi1_49_npi2_1_test_vac.png", width = 7, height = 5)
graphics.off()
...
ggsave(out_plot8, filename = "plot8_Rt1.1_npi1_64_npi2_0.9_test_vac.png", width = 7, height = 5)
graphics.off()
...
ggsave(out_plot9, filename = "plot9_Rt1.1_npi1_78_npi2_0.9_test_vac.png", width = 7, height = 5)
graphics.off()

...
#  geom_ribbon(data = q3, aes(x = dates, ymin = low, ymax = high), fill="red", alpha = .15) +
  ...
  geom_vline(aes(xintercept = as.numeric(dates[c(90+150)])), linetype = 2, color = 'red') +
  scale_y_continuous(breaks = seq(0,100000,10000), minor_breaks = seq(0,100000,10000), limits = c(0, 100000), expand = c(0, 0)) + ## scale_y_continuous(label=comma)
  ylab('Incidence') +
  xlab('Date') +
  ggtitle('') +

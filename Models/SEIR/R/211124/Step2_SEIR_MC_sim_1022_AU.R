...
vac1 <- function(t) (t >= 1 & t < 96) * mean(vac)*2+
  (t >= 96 & t < 180) * mean(vac)*2+
  (t >= 180 & t < 360) * mean(vac)*vr*4+
  (t >= 360 & t < 540) * mean(vac)*4
# 
...
npi=1 #0.85
npi_d=150+90 ##NPI by April 2022 by Feb 2022 by Jun 2022

contactpattern <- function(t, aver_Rt) (t >= 1 & t <30) * aver_Rt*1/14*(1/contact)*0.5 + 
  (t >= 30 & t < 90) * aver_Rt*1/14*(1/contact)*1.1 +   ##Rt1.1
  (t >= 90 & t < npi_d) * aver_Rt*1/14*(1/contact)*rt*npi*1.1 + ##Rt1.3
  (t >= npi_d & t  < lastdate) * aver_Rt*1/14*(1/contact)*rt*30

...
contactpattern <- function(t, aver_Rt) (t >= 1 & t < 90) * aver_Rt*1/14*(1/contact)*0.2 + 
  (t >= 90 & t  < npi_d) * aver_Rt*1/14*(1/contact)*rt*npi*0.8 + ##Rt1.3
  (t >= npi_d & t  < lastdate) * aver_Rt*1/14*(1/contact)*rt*10 ##Transimissibility increaes  3.5/4/4.5 --> Rt: 2.8/3.2/3.7

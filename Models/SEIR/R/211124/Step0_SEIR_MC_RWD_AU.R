...
df_au<-df1%>% filter(state=="Australia")
df_au1<-df_au[df_au$date>="2021-06-01" & df_au$date <"2021-10-04",]
df_au1$people_vaccinated[is.na(df_au1$people_vaccinated)]<-mean(df_au1$people_vaccinated, na.rm = TRUE)
df_au1$people_fully_vaccinated[is.na(df_au1$people_fully_vaccinated)]<-mean(df_au1$people_fully_vaccinated, na.rm = TRUE)
#df_au1[is.na(df_au1)] <- 0

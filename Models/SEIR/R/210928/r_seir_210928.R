...
last_date<- '2021-12-31' #184 숫자를 맞추기 위해
...
###owid.csv 파일을 사용할때 ###
setwd('/Users/hong-eun-yeong/Desktop/hey/K6_AI_gil/SEIR/02_code/SEIR/R/210928/')

df<-read.csv("../../../../01_data/SEIR/owid-covid-data_0926.csv")
...
incidence1<-subset(incidence, dates >= start_date)
...
Rt1<-subset(Rt, Rt$t_start > dim(Rt)[1] - dim(incidence1)[1] +1 )
Rt1$time <- 1:nrow(Rt1)
...
date_fuc<-function(month_num){
  paste('2021-',month(start_date)+ month_num,'-01',sep='')
}

date_fuc2<-function(month_num){
  paste(month(start_date)+month_num,'-01',sep='')
}

# as.Date(c(start_date, last_date))
# as.Date(c(date_fuc(0),date_fuc(1),date_fuc(2), date_fuc(3), date_fuc(4), date_fuc(5)))
# (c(date_fuc2(0),date_fuc2(1),date_fuc2(2), date_fuc2(3), date_fuc2(4), date_fuc2(5)))
...
plot_graph_TP <- function (file_save,r,n_,v,te) {
  plot1<-ggplot(q1) +
    ...
    xlab('Date') +
    ggtitle('') +
    scale_x_date(limits = as.Date(c(start_date, last_date)), 
                 breaks = as.Date(c(date_fuc(0),date_fuc(1),date_fuc(2), date_fuc(3), date_fuc(4), date_fuc(5))),
                 labels=c (date_fuc2(0),date_fuc2(1),date_fuc2(2), date_fuc2(3), date_fuc2(4), date_fuc2(5)))+
    theme_classic()+
...
plot_graph_S <- function (file_save,r,n_,v,te) {
  ...
  plot1<-ggplot(q1) + 
    ...
    geom_vline(aes(xintercept = as.numeric(dates[c(87)])), linetype = 2, color = 'red') +
    scale_y_continuous(breaks = seq(0,1000,100), minor_breaks = seq(0,1000,100), limits = c(0, 1000)) + ## scale_y_continuous(label=comma)
    ylab('Incidence') +
    xlab('Date') +
    ggtitle('') +
    scale_x_date(limits = as.Date(c(start_date, last_date)), 
...
plot_graph_D <- function (file_save,r,n_,v,te) {
  ...
  plot1<-ggplot(q1) + 
    ...
    geom_vline(aes(xintercept = as.numeric(dates[c(87)])), linetype = 2, color = 'red') +
    scale_y_continuous(breaks = seq(0,1200,200), minor_breaks = seq(0,1200,200), limits = c(0, 1200)) + ## scale_y_continuous(label=comma)
    ylab('Incidence') +
    xlab('Date') +
    ggtitle('') +
    scale_x_date(limits = as.Date(c(start_date, last_date)), 
...
plot_graph_TP1 <- function (file_save,r,n_,v,te) {
  plot1<-ggplot(q1) +
    geom_point(aes(x = dates, y = I), size = 1.5, color = "darkblue", fill = "white") +
    geom_line(aes(x = dates, y = I), size = 1, color = "darkblue", fill = "white") +
    geom_line(aes(x = dates, y = TP1.incidence), size = 2, color="red", group = 1) + 
    geom_ribbon(data = q1, aes(x = dates, ymin = TP1.incidence-300, ymax = TP1.incidence+300), alpha = .1) +
    
    geom_line(data=q2, aes(x = dates, y = TP1.incidence), size = 2, color = "#FF9999", fill = "white") +
    geom_ribbon(data = q2, aes(x = dates, ymin = TP1.incidence-300, ymax = TP1.incidence+300), alpha = .1) +
    
    geom_line(data=q3, aes(x = dates, y = TP1.incidence), size = 2, color = "#CC0033", fill = "white") +
    geom_ribbon(data = q3, aes(x = dates, ymin = TP1.incidence-300, ymax = TP1.incidence+300), alpha = .1) +
...
plot_graph_TP2 <- function (file_save,r,n_,v,te) {
  plot1<-ggplot(q1) +
    geom_point(aes(x = dates, y = I), size = 1.5, color = "darkblue", fill = "white") +
    geom_line(aes(x = dates, y = I), size = 1, color = "darkblue", fill = "white") +
    geom_line(aes(x = dates, y = TP2.incidence), size = 2, color="red", group = 1) + 
    geom_ribbon(data = q1, aes(x = dates, ymin = TP2.incidence-300, ymax = TP2.incidence+300), alpha = .1) +
    
    geom_line(data=q2, aes(x = dates, y = TP2.incidence), size = 2, color = "#FF9999", fill = "white") +
    geom_ribbon(data = q2, aes(x = dates, ymin = TP2.incidence-300, ymax = TP2.incidence+300), alpha = .1) +
    
    geom_line(data=q3, aes(x = dates, y = TP2.incidence), size = 2, color = "#CC0033", fill = "white") +
    geom_ribbon(data = q3, aes(x = dates, ymin = TP2.incidence-300, ymax = TP2.incidence+300), alpha = .1) +
...
plot_graph_TP3 <- function (file_save,r,n_,v,te) {
  plot1<-ggplot(q1) +
    geom_point(aes(x = dates, y = I), size = 1.5, color = "darkblue", fill = "white") +
    geom_line(aes(x = dates, y = I), size = 1, color = "darkblue", fill = "white") +
    geom_line(aes(x = dates, y = TP3.incidence), size = 2, color="red", group = 1) + 
    geom_ribbon(data = q1, aes(x = dates, ymin = TP3.incidence-300, ymax =TP3.incidence+300), alpha = .1) +
    
    geom_line(data=q2, aes(x = dates, y =TP3.incidence), size = 2, color = "#FF9999", fill = "white") +
    geom_ribbon(data = q2, aes(x = dates, ymin = TP3.incidence-300, ymax = TP3.incidence+300), alpha = .1) +
    
    geom_line(data=q3, aes(x = dates, y = TP3.incidence), size = 2, color = "#CC0033", fill = "white") +
    geom_ribbon(data = q3, aes(x = dates, ymin = TP3.incidence-300, ymax = TP3.incidence+300), alpha = .1) +
...
plot_graph_TP4 <- function (file_save,r,n_,v,te) {
  plot1<-ggplot(q1) +
    geom_point(aes(x = dates, y = I), size = 1.5, color = "darkblue", fill = "white") +
    geom_line(aes(x = dates, y = I), size = 1, color = "darkblue", fill = "white") +
    geom_line(aes(x = dates, y = TP4.incidence), size = 2, color="red", group = 1) + 
    geom_ribbon(data = q1, aes(x = dates, ymin = TP4.incidence-300, ymax = TP4.incidence+300), alpha = .1) +
    
    geom_line(data=q2, aes(x = dates, y = TP4.incidence), size = 2, color = "#FF9999", fill = "white") +
    geom_ribbon(data = q2, aes(x = dates, ymin = TP4.incidence-300, ymax = TP4.incidence+300), alpha = .1) +
    
    geom_line(data=q3, aes(x = dates, y = TP4.incidence), size = 2, color = "#CC0033", fill = "white") +
    geom_ribbon(data = q3, aes(x = dates, ymin = TP4.incidence-300, ymax = TP4.incidence+300), alpha = .1) +
...
for (value_ in c_list){
  ...
  for (r in rt_){
    for (n_ in npi_){
      ...
      t <- seq(1, date_, by=1)
      contactpattern <- function(t) (t >= 1 & t < 49) * mean(beta)*0.35+
      ...
      for (v in vac_){
        ...
        for (te in test_){
          tau2<-test$new_tests/100000
          t <- seq(1, date_, by=1)
          tau2_1 <- function(t) (t >= 1 & t < 49) * mean(tau2)*0.35 +
            (t >= 49 & t < date_) * mean(tau2)*0.35*te
...
# 
# 
# #setwd("/Users/hong-eun-yeong/Desktop/hey/K6_AI_gil/git_re/03_code/SEIR/version7/hey_seir_version7_age/")
# lastdate =184
# result_final<-read.csv("result_TP_final.csv")
# rt <-3.5
# npi<- 0.85
# vr <- 0.8
# tr <- 1
# result3 <- result_final[result_final$case==paste("RT_",rt,"NPI1",npi,"VACCINE_",vr,"TEST_",tr),]
# rt <-4
# npi<- 0.85
# vr <- 0.8
# tr <- 1
# result4 <- result_final[result_final$case==paste("RT_",rt,"NPI1",npi,"VACCINE_",vr,"TEST_",tr),]
# rt <-4.5
# npi<- 0.85
# vr <- 0.8
# tr <- 1
# result5 <- result_final[result_final$case==paste("RT_",rt,"NPI1",npi,"VACCINE_",vr,"TEST_",tr),]
# 
# 
...
#   scale_y_continuous(breaks = seq(0,250000,50000), minor_breaks = seq(0,250000,50000), limits = c(0, 250000), expand = c(0, 0)) + ## scale_y_continuous(label=comma)
#   ylab('Incidence') +
#   xlab('Date') +
#   ggtitle('') +
...
# #   
# #   geom_vline(aes(xintercept = as.numeric(dates[c(96)])), linetype = 2, color = 'red') +
# #   scale_y_continuous(breaks = seq(0,50000,5000), minor_breaks = seq(0,50000,5000), limits = c(0, 50000), expand = c(0, 0)) + ## scale_y_continuous(label=comma)
# #   ylab('Incidence') +
# #   xlab('Date') +
# #   ggtitle('') +
# #   scale_x_date( limits = as.Date(c("2021-07-01", "2023-12-30")), breaks = as.Date( c( "2021-07-01",  "2021-09-01",  "2021-11-01",
...
# library(lubridate)
# 
# #setwd("/Users/hong-eun-yeong/Documents/GitHub/gil-arim-and-eunyeong/03_code/SEIR/version6/backup/hey_seir_version6_age/")
# 
# rt_ <- c(1.05,1,1.1)
# npi_ <- c(49,64,78) # (t >= 49 & t < n_) * mean(beta)*0.343*r*0.95에 49를 넣으면 0으로 되어 결국 1<= t <184가 되어 0week이 49라는 변수를 가지게 됩니다.
# vac_ <- c(1,0.5,1.5)
...
#       
#       for (r in rt_){ 
#         result_final <- read.csv(file = "1006result_TP_final.csv")
...
#         num = num+1
#       }
#       plot_graph_TP1( file_save="image/RT/TP/TP1/",r='1,1.05,1.1',n_,v,te)
#       plot_graph_TP2( file_save="image/RT/TP/TP2/",r='1,1.05,1.1',n_,v,te)
#       plot_graph_TP3( file_save="image/RT/TP/TP3/",r='1,1.05,1.1',n_,v,te)
#       plot_graph_TP4( file_save="image/RT/TP/TP4/",r='1,1.05,1.1',n_,v,te)
#       
#       for(i in 1:3) {
#         assign(paste0("q",i),i)  #q1,q2,q3 변수 생성 
#       }
...
#       
#       for (r in rt_){ 
#         result_final <- read.csv(file = "1006result_S_D_final.csv")
#         result3 <- result_final[result_final$case==paste("RT_",r,"NPI_",n_,"VACCINE_",v,"TEST_",te),]
#         assign(paste0("q",num), merge(incidence1, result3, by="time", all.y = TRUE, no.dups = TRUE))
#         calender <- seq(ymd(final_date), ymd(last_date), by="day")
#         for (i in 50:date_){
...
#       plot_graph_TP1( file_save="image/TEST/TP/TP1/",r,n_,v,te='0.8,1,1.2')
#       plot_graph_TP2( file_save="image/TEST/TP/TP2/",r,n_,v,te='0.8,1,1.2')
#       plot_graph_TP3( file_save="image/TEST/TP/TP3/",r,n_,v,te='0.8,1,1.2')
#       plot_graph_TP4( file_save="image/TEST/TP/TP4/",r,n_,v,te='0.8,1,1.2')
#       
#       for(i in 1:3) {
#         assign(paste0("q",i),i)  #q1,q2,q3 변수 생성 
#       }
...
#       plot_graph_TP1( file_save="image/NPI/TP/TP1/",r,n_='49,64,78',v,te)
#       plot_graph_TP2( file_save="image/NPI/TP/TP2/",r,n_='49,64,78',v,te)
#       plot_graph_TP3( file_save="image/NPI/TP/TP3/",r,n_='49,64,78',v,te)
#       plot_graph_TP4( file_save="image/NPI/TP/TP4/",r,n_='49,64,78',v,te)
#       
#       for(i in 1:3) {
#         assign(paste0("q",i),i)  #q1,q2,q3 변수 생성 
#       }
...
#       plot_graph_TP1( file_save="image/VAC/TP/TP1/",r,n_,v='0.5,1,1.5',te)
#       plot_graph_TP2( file_save="image/VAC/TP/TP2/",r,n_,v='0.5,1,1.5',te)
#       plot_graph_TP3( file_save="image/VAC/TP/TP3/",r,n_,v='0.5,1,1.5',te)
#       plot_graph_TP4( file_save="image/VAC/TP/TP4/",r,n_,v='0.5,1,1.5',te)
#       
#       for(i in 1:3) {
#         assign(paste0("q",i),i)  #q1,q2,q3 변수 생성 
#       }
...
# library(lubridate)
# 
# setwd("/Users/hong-eun-yeong/Documents/GitHub/gil-arim-and-eunyeong/03_code/SEIR/version4/")
# 
# rt_ <- c(1.05,1,1.1)
# npi_ <- c(49,64,78) # (t >= 49 & t < n_) * mean(beta)*0.343*r*0.95에 49를 넣으면 0으로 되어 결국 1<= t <184가 되어 0week이 49라는 변수를 가지게 됩니다.
# vac_ <- c(1,0.5,1.5)
...
#       
#       for (r in rt_){ 
#         result_final <- read.csv(file = "0924result_TP_final.csv")
#         result3 <- result_final[result_final$case==paste("RT_",r,"NPI_",n_,"VACCINE_",v,"TEST_",te),]
#         assign(paste0("q",num), merge(incidence1, result3, by="time", all.y = TRUE, no.dups = TRUE))
#         calender <- seq(ymd(final_date), ymd(last_date), by="day")
#         for (i in 50:date_){
...
#       
#       for (r in rt_){ 
#         result_final <- read.csv(file = "0924result_S_D_final.csv")
#         result3 <- result_final[result_final$case==paste("RT_",r,"NPI_",n_,"VACCINE_",v,"TEST_",te),]
#         assign(paste0("q",num), merge(incidence1, result3, by="time", all.y = TRUE, no.dups = TRUE))
#         calender <- seq(ymd(final_date), ymd(last_date), by="day")
#         for (i in 50:date_){
